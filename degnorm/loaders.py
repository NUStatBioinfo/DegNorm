...
#
#         +----------------+----------------+----------------+----------------+--------------------+
#         |     qname      |     chr        |     pos        |     cigar      |   qname_unpaired   |
#         +================+================+================+================+====================+
#         | SRR89.1166.1   |     chr1       |    13785       |     100M       |     SRR89.1166     |
#         +----------------+----------------+----------------+----------------+--------------------+
#         | SRR89.1166.2   |     chr1       |    13791       |     100M       |     SRR89.1166     |
#         +----------------+----------------+----------------+----------------+--------------------+
#
...
#             lines = f.readlines()
#
#         # get header from .sam file (safe assumption it occurs in the first 300 lines)
#         header_df, header_idx = self.separate_header(lines[0:300])
#
